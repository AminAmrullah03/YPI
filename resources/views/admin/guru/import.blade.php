...
@section('page-subtitle', 'Import Guru')
    ...
    <div style="max-width: 680px; margin: 0 auto;">
        ...
        <div class="card" style="margin-bottom:20px;">
            <div style="font-size:16px; font-weight:700; color:#1e293b; margin-bottom:20px; border-bottom:1px solid #e2e8f0; padding-bottom:12px; display:flex; align-items:center; gap:8px;">
                <i class="ph ph-file-xls" style="color:#0891b2; font-size:20px;"></i>
                Import Massal Guru via Excel
            </div>

            <div style="background:rgba(8,145,178,0.06); border-left:4px solid #0891b2; border-radius:8px; padding:16px; margin-bottom:24px; font-size:13.5px; color:#1e293b; line-height:1.6;">
                <div style="font-weight:700; margin-bottom:6px; color:#0e7490;">Langkah Import Data:</div>
                <ol style="margin:0; padding-left:20px; display:flex; flex-direction:column; gap:4px;">
                    ...
                    <li>Isi data guru Anda ke dalam file Excel tersebut sesuai dengan kolom & format contoh.</li>
            ...
            <div style="margin-bottom:24px; text-align:center; padding:16px; border:1px dashed #cbd5e1; border-radius:12px; background:#f8fafc;">
                ...
                <a href="{{ route('admin.guru.template') }}" class="btn btn-secondary btn-sm" style="border-color:#0891b2; color:#0891b2; padding:8px 16px;">
                    <i class="ph ph-download-simple"></i> Download Template Guru
                </a>
            </div>
            ...
            <form method="POST" action="{{ route('admin.guru.import') }}" enctype="multipart/form-data">
                ...
                <div style="border-top:1px solid #e2e8f0; padding-top:16px; display:flex; justify-content:flex-end;">
                    <button type="submit" class="btn btn-primary" style="padding:10px 20px; background:#0891b2;">
