...
@section('page-subtitle', 'Tambah Guru')
            ...
            <form method="POST" action="{{ route('admin.guru.store') }}" enctype="multipart/form-data">
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                    ...
                    <div class="form-group" style="grid-column: span 2;">
                        ...
                        <input type="text" name="nama" id="nama" class="form-input @error('nama') is-invalid @enderror" placeholder="Nama lengkap beserta gelar..." value="{{ old('nama') }}" required>
                        @error('nama')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nik" id="nik" class="form-input @error('nik') is-invalid @enderror" placeholder="16 digit NIK..." value="{{ old('nik') }}" maxlength="16" required>
                        @error('nik')
                            <span style="font-size:12px; color:#ef4444; margin-top:4px; display:block;">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nuptk" id="nuptk" class="form-input @error('nuptk') is-invalid @enderror" placeholder="Masukkan NUPTK..." value="{{ old('nuptk') }}" maxlength="16">
                        @error('nuptk')
                            <span style="font-size:12px; color:#ef4444; margin-top:4px; display:block;">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pendidikan_terakhir" id="pendidikan_terakhir" class="form-input @error('pendidikan_terakhir') is-invalid @enderror" placeholder="Contoh: S1 Pendidikan, SMA, dll..." value="{{ old('pendidikan_terakhir') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="telepon" id="telepon" class="form-input @error('telepon') is-invalid @enderror" placeholder="Contoh: 08123456789..." value="{{ old('telepon') }}">
                        @error('telepon')
                            <span style="font-size:12px; color:#ef4444; margin-top:4px; display:block;">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group" style="grid-column: span 2;">
                        ...
                        <textarea name="alamat" id="alamat" class="form-textarea @error('alamat') is-invalid @enderror" rows="3" placeholder="Tuliskan alamat tinggal lengkap...">{{ old('alamat') }}</textarea>
                        @error('alamat')
                            <span style="font-size:12px; color:#ef4444; margin-top:4px; display:block;">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jabatan" id="jabatan" class="form-input @error('jabatan') is-invalid @enderror" placeholder="Contoh: Guru Kelas, Wali Kelas, Kepala Sekolah..." value="{{ old('jabatan') }}" required>
                        @error('jabatan')
                            <span style="font-size:12px; color:#ef4444; margin-top:4px; display:block;">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="mata_pelajaran" id="mata_pelajaran" class="form-input @error('mata_pelajaran') is-invalid @enderror" placeholder="Contoh: Matematika, Bahasa Arab..." value="{{ old('mata_pelajaran') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_masuk" id="tanggal_masuk" class="form-input @error('tanggal_masuk') is-invalid @enderror" value="{{ old('tanggal_masuk', date('Y-m-d')) }}" required>
                        @error('tanggal_masuk')
                            <span style="font-size:12px; color:#ef4444; margin-top:4px; display:block;">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_keluar" id="tanggal_keluar" class="form-input @error('tanggal_keluar') is-invalid @enderror" value="{{ old('tanggal_keluar') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_kepegawaian" id="status_kepegawaian" class="form-select @error('status_kepegawaian') is-invalid @enderror" required>
                            ...
                            @foreach(\App\Models\Guru::STATUS_KEPEGAWAIAN_LIST as $val => $label)
                                <option value="{{ $val }}" {{ old('status_kepegawaian') == $val ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
