...
<div class="content-area">
    ...
    <div style="margin-bottom:16px;">
        <a href="{{ route('super-admin.guru.index') }}" class="btn btn-secondary btn-sm" style="display:inline-flex; align-items:center; gap:6px;">
        ...
        <div class="card" style="display:flex; flex-direction:column; align-items:center; text-align:center;">
            ...
            <div style="width:100%; border-top:1px solid #f1f5f9; padding-top:16px; margin-top:8px; text-align:left; display:flex; flex-direction:column; gap:10px;">
                <div>
                    ...
                    <div style="font-size:13.5px; color:#1e293b; font-weight:600;">{{ $guru->lembaga?->nama }} ({{ $guru->lembaga?->jenis_label }})</div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div style="font-size:13.5px; color:#475569;">{{ $guru->createdBy?->name ?? 'System / Admin' }}</div>
                </div>
            </div>
        </div>
