    ...
    <div style="display:grid; grid-template-columns:repeat(auto-fit,minmax(220px,1fr)); gap:16px; margin-bottom:28px;">
        ...
        <div class="stat-card" style="grid-column: span 2; display:flex; justify-content:space-between; align-items:center; background:linear-gradient(135deg, #0f172a 0%, #1e293b 100%); border:none;">
            <div style="display:flex; align-items:center; gap:16px;">
                ...
                <div>
                    <div style="font-size:16px; font-weight:700; color:#fff;">Rekapitulasi PDF</div>
                    <div style="font-size:12px; color:rgba(255,255,255,0.6); margin-top:4px;">Unduh ringkasan data yayasan format PDF.</div>
                </div>
            </div>
            <a href="{{ route('super-admin.laporan.export-pdf') }}" class="btn btn-primary" style="background:#ef4444; border-radius:12px; box-shadow: 0 4px 12px rgba(239,68,68,0.3);">
    ...
    <div style="display:grid; grid-template-columns: 1fr 1fr; gap:20px;">
        ...
        <div class="card">
            ...
            <p style="font-size:13.5px; color:#64748b; margin:0 0 20px; line-height:1.5;">
                Gunakan formulir di bawah untuk memfilter data siswa berdasarkan lembaga dan status sebelum mengunduh laporan Excel.
            </p>
                ...
                <div class="form-group" style="margin-bottom:12px;">
                    ...
                    <select name="lembaga_id" class="form-select">
                        ...
                        @foreach($lembagaList as $lem)
                            <option value="{{ $lem->id }}">{{ $lem->nama }} ({{ $lem->jenis_label }})</option>
                        @endforeach
                    </select>
                </div>
        ...
        <div class="card">
            ...
            <p style="font-size:13.5px; color:#64748b; margin:0 0 20px; line-height:1.5;">
                Gunakan formulir di bawah untuk memfilter data guru berdasarkan lembaga dan status sebelum mengunduh laporan Excel.
            </p>

            <form method="GET" action="{{ route('super-admin.laporan.export-guru') }}">
